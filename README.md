...
3. Пусть есть матрица $$A = \begin{pmatrix} 1 & 0 \\ 0 & 1 \end{pmatrix}$$ и матрица $$B = \begin{pmatrix} 2 & -1 \\ 2 & -1 \end{pmatrix}$$, тогда если в строке заменить букву $a$ на матрицу A, 
